package com.pms.application.views.dashboard;


import com.pms.application.views.dashboard.ServiceHealth.Status;
...
@PageTitle("Dashboard")
@Menu(icon = "line-awesome/svg/chart-area-solid.svg", order = 2)
